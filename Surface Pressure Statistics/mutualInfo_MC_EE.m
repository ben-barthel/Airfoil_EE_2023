function [I] = mutualInfo_MC_EE(vec1,vec2,nbins,cut_off)
...
% limit to extreme events
f2(abs(x2) < co) = 0; %ouput

% [X1,X2] = meshgrid(x1,x2); 
% if size(X2,1) ~= size(f12,1)
%     X2 = X2';
% %     disp('permuted X2')
% end
% f12(abs(X2) < co) = 0; %joint
